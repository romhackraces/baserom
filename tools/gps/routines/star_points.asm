...
.loop
	...
	LDA $18D2|!addr			; Check amount of enemies having been stomped on.
...
+	LDA $18D2|!addr			; Check how many enemies have been stomped.
	CMP #$7F			; Is it 7F?
	BEQ ++				; Go to ++ to freeze the counter at 7F (to keep the code from bugging)

	INC $18D2|!addr			; Increase the amount of enemies stomped.
